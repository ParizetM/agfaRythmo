<template>
  <Transition name="modal">
    ...
    >
      <div
        class="bg-agfa-dark border border-gray-700/50 rounded-xl shadow-2xl w-full max-w-7xl max-h-[95vh] overflow-hidden flex flex-col"
        @click.stop
      >
        <!-- Content -->
        <div class="flex-1 overflow-y-auto">
          <div class="p-4 sm:p-6 lg:p-8 relative">
            ...
            <button
              @click="closeModal"
              class="absolute top-4 right-4 w-10 h-10 flex items-center justify-center rounded-full bg-agfa-button hover:bg-gray-600 text-gray-400 hover:text-white transition-all duration-200 z-10"
              title="Fermer (Échap)"
            >
            ...
            <!-- Titre principal -->
            <div class="text-center mb-6 sm:mb-8 pr-12">
              <h1 class="text-2xl sm:text-3xl lg:text-4xl font-bold text-white mb-2">Paramètres du Projet</h1>
              <p class="text-sm sm:text-base text-gray-400">Personnalisez l'apparence des bandes rythmo</p>
            </div>

            <!-- Onglets -->
            <div class="tabs-container mb-6 sm:mb-8 overflow-x-auto">
            ...
            <div v-show="activeTab === 'settings'" class="grid grid-cols-1 xl:grid-cols-2 gap-6 lg:gap-8">
              <!-- Colonne Formulaire -->
              <div class="space-y-5 sm:space-y-6 order-2 xl:order-1">
                <!-- Hauteur de la bande -->
                ...
                <!-- Boutons d'action -->
                <div class="flex flex-col sm:flex-row gap-3 sm:gap-4 pt-4 border-t border-gray-700">
                  <button
              ...
              <div class="space-y-4 order-1 xl:order-2">
                <div class="text-center">
                  <h3 class="text-base sm:text-lg font-semibold text-gray-300 mb-4">Aperçu en direct</h3>
                </div>
                ...
                >
                  <div class="preview-video-area">
                    <div class="preview-video-placeholder">
                      <svg class="w-12 h-12 sm:w-16 sm:h-16 lg:w-20 lg:h-20 text-gray-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
.preview-block.active {
  box-shadow: 0 0 0 2px rgba(255, 255, 255, 0.5), 0 4px 12px rgba(72, 187, 120, 0.3);
